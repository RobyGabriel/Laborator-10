...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < vectorParinte.length; i++) {
            System.out.println("Elementul" + i + "= " + vectorParinte[i]);
        }

        for (ClasaCopil v : vectorCopil) {
    ...
    public static void afisareVectorCopil(ArrayList<ClasaCopil> vectorCopil) {
